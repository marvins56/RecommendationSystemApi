namespace RecommendationSystemApi.Models
{
    ...
    public class RatingSmall
    {
        ...
        public double RatingValue { get; set; } // The rating given by the user
        public long Timestamp { get; set; } // Timestamp when the rating was given, assumed to be Unix time
